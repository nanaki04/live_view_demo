defmodule SpaceBirds.UI.StatsPanel do
  ...
  def run(node, component, arena) do
    ...
    do
      ...
      build_nodes(node, player.name, stats, buff_debuff_stack, component, arena)
    else
      _ ->
  ...
  @spec build_nodes(Node.t, String.t, Component.t, Component.t, Component.t, Arena.t) :: {:ok, Arena.t} | {:error, String.t}
  def build_nodes(node, name, stats, buff_debuff_stack, component, arena) do
